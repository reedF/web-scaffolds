...
import com.reed.pay.HttpProtocolHandler;
import com.reed.pay.HttpRequest;
import com.reed.pay.HttpResponse;
import com.reed.pay.HttpResultType;
...
//        }
    ...
    public static String buildRequest(Map<String, String> sParaTemp) throws Exception {
        ...
        response.setCharset(AlipayConfig.input_charset);
        String strResult = response.getStringResult();
        return strResult;
    }

    public static boolean parseXML(String xml) throws DocumentException{
